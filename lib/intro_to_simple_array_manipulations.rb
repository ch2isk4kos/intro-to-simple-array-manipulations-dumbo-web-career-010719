# takes in two arguments, an array and a string and adds that
...
# takes in argument of an array and uses the pop method to remove
# the last element from the array and return that element
def using_pop(array)
    return array.pop
end

# takes in an argument of an array and uses the pop method with an
...
# takes in an argument of an array and uses the shift method with
# an argument of 2 to remove and return the first 2 items from the array
def shift_with_args(array)
    array.shift(2)
end

# takes in two arguments of two different arrays and uses
# the concat method to add the contents of the second array to the first
...
# takes in an argument of an array and uses the uniq method
...
# and uses the flatten method
def using_flatten(array)
    array.flatten
end

# takes in two arguments, an array and a string, and uses the
# delete method to remove any items from the array that are equal to that string
def using_delete(array, string)
    array.delete(string)
end

# takes in two arguments, an array and an integer and deletes the element
# at the index of the array that is equal to that integer
